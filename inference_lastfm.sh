...
#     "./output_1/lastfm/random_gamma_1.0_final_checkpoint"
    ...
    #"./output/lastfm/goodreads_random_dyg_gamma_1.0_alpha1_0.1_neg_accept_ratio_0.7_batch_shared_True_neg_num_3_final_checkpoint"
    #"./output/lastfm/lastfm_random_dyg_gamma_1.0_alpha1_0.0_neg_accept_ratio_0.7_batch_shared_False_neg_num_3_final_checkpoint"
    # "./output/lastfm/lastfm_random_dyg_gamma_1.0_alpha1_0.0_neg_accept_ratio_0.7_batch_shared_True_neg_num_3_final_checkpoint"
    #"./output/lastfm/lastfm_random_dyg_gamma_1.0_alpha1_0.1_neg_accept_ratio_0.7_batch_shared_True_neg_num_3_final_checkpoint"
    # "./output/lastfm/lastfm_random_dyg_gamma_1.0_alpha1_0.3_neg_accept_ratio_0.7_batch_shared_True_neg_num_3_final_checkpoint"
    #"./output/lastfm/simpo_random/dataset_lastfm_gamma_1.0_alpha1_0.0_neg_accept_ratio_0.7_batch_shared_True_neg_num_3/checkpoint-1122"
    "./output/lastfm/lastfm_random_dyg_gamma_1.0_alpha1_0.5_neg_accept_ratio_0.7_batch_shared_True_neg_num_3_final_checkpoint"
    "./output/lastfm/lastfm_random_dyg_gamma_1.0_alpha1_0.5_neg_accept_ratio_0.7_batch_shared_False_neg_num_3_final_checkpoint"
